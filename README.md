...
My own work on every item (and every material per weapon) still involved creating the blade or component texture, registering the item, and designing the forging recipe.
